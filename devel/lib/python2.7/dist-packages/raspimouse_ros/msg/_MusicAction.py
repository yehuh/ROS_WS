...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%sH'%length
      buff.write(struct.Struct(pattern).pack(*self.action_goal.goal.freqs))
      length = len(self.action_goal.goal.durations)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.action_goal.goal.durations))
      _x = self
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_feedback.feedback.remaining_steps
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.action_goal.goal.freqs = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.action_goal.goal.durations = s.unpack(str[start:end])
      _x = self
      start = end
      end += 12
