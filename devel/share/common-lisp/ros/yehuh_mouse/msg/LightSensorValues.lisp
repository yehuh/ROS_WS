...
(cl:defmethod cl:initialize-instance :after ((m <LightSensorValues>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LightSensorValues)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name yehuh_mouse-msg:<LightSensorValues> is deprecated: use yehuh_mouse-msg:LightSensorValues instead.")))

(cl:ensure-generic-function 'right_forward-val :lambda-list '(m))
(cl:defmethod right_forward-val ((m <LightSensorValues>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yehuh_mouse-msg:right_forward-val is deprecated.  Use yehuh_mouse-msg:right_forward instead.")
  (right_forward m))

(cl:ensure-generic-function 'right_side-val :lambda-list '(m))
(cl:defmethod right_side-val ((m <LightSensorValues>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yehuh_mouse-msg:right_side-val is deprecated.  Use yehuh_mouse-msg:right_side instead.")
  (right_side m))

(cl:ensure-generic-function 'left_side-val :lambda-list '(m))
(cl:defmethod left_side-val ((m <LightSensorValues>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yehuh_mouse-msg:left_side-val is deprecated.  Use yehuh_mouse-msg:left_side instead.")
  (left_side m))

(cl:ensure-generic-function 'left_forward-val :lambda-list '(m))
(cl:defmethod left_forward-val ((m <LightSensorValues>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yehuh_mouse-msg:left_forward-val is deprecated.  Use yehuh_mouse-msg:left_forward instead.")
  (left_forward m))
